...
export default function App() {
  ...
  const [isHovered, setIsHovered] = useState(false); // NEW: Tracks mouse hover state
  ...
  // 3. Animation Loop (UPDATED: Pauses when hovered)
  useEffect(() => {
    let interval;
    ...
    <div className="min-h-screen flex font-sans">
      ...
      <main className="flex-1 p-8 overflow-y-auto">
        ...
        <div className="glass-card">
          ...
          <p className="text-sm text-gray-400 mb-4">Click locations to drill down. Hover over the map to pause animation.</p>
          {/* UPDATED: Map Container tracks mouse enter and leave events */}
          <div 
            ...
            {level === 'global' ? (
              ...
              <Plot
                ...
                layout={{
                  ...
                  paper_bgcolor: 'rgba(0,0,0,0)',
                  geo: { 
                    fitbounds: 'locations', // UPDATED: Automatically zooms to data bounds
